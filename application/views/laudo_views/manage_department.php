<div class="box">
	<div class="box-header">
		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> Lista Departamento
					<?php //echo get_phrase('edit_department');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> Lista Departamento
					<?php //echo get_phrase('department_list');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i> Add Departamento 
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	<thead>
                		<tr>
                    		...
                    		<th style="width:40%"><div>NOME<?php //echo get_phrase('department_name');?></div></th>
                    		<th style="width:40%"><div>DESCRICAO<?php //echo get_phrase('description');?></div></th>
                    		<th style="width:10%"><div>OPÇÕES<?php //echo get_phrase('options');?></div></th>
						</tr>
					</thead>
                    <tbody>
